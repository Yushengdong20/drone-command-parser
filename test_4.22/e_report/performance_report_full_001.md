...
|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 9.68 | 7.20 | 8.81 | 6.61 | 32.29 | 100.00% |
| qwen3.5:0.8b | 18.59 | 891.94 | 1.96 | 2.27 | 914.76 | 75.00% |
| qwen3.5:2b | 8.01 | 3.09 | 3.21 | 2.43 | 16.73 | 100.00% |
| qwen3.5:4b | 24.31 | 8.92 | 17.06 | 6.68 | 56.97 | 100.00% |
### 基础动作 - 方向移动

| 模型 | 升高2m |向前2m |向前飞10米 |向右5m |向后3m |向左1m |往后退3米 |降低1m | 分类总时间 | 分类匹配率 |
|------|------|------|------|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 11.98 | 6.05 | 6.22 | 11.12 | 14.54 | 8.36 | 8.06 | 9.42 | 75.74 | 100.00% |
| qwen3.5:0.8b | 1.88 | 1.56 | 1.56 | 1.53 | 2.14 | 3.43 | 2.51 | 1.78 | 16.40 | 100.00% |
| qwen3.5:2b | 3.24 | 2.05 | 3.13 | 2.64 | 3.00 | 3.34 | 2.48 | 2.85 | 22.73 | 100.00% |
| qwen3.5:4b | 28.43 | 6.87 | 9.29 | 15.79 | 10.49 | 13.63 | 10.09 | 14.63 | 109.23 | 100.00% |
### 航向控制 - 绝对角度

| 模型 | 机头朝东 |机头朝北 |机头朝南 |机头朝西 |转向正东 |转向正北 |转向正南 |转向正西 | 分类总时间 | 分类匹配率 |
|------|------|------|------|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 48.44 | 10.58 | 28.07 | 12.25 | 14.76 | 12.81 | 22.60 | 15.49 | 165.00 | 100.00% |
| qwen3.5:0.8b | 1.97 | 2.37 | 875.36 | 2.04 | 2.81 | 842.86 | 1.65 | 2.05 | 1731.12 | 62.50% |
| qwen3.5:2b | 3.32 | 3.46 | 3.76 | 3.23 | 3.11 | 2.79 | 2.66 | 3.94 | 26.26 | 100.00% |
| qwen3.5:4b | 39.48 | 22.55 | 7.94 | 16.69 | 15.82 | 19.88 | 8.04 | 17.68 | 148.09 | 100.00% |
### 航向控制 - 相对角度

| 模型 | 原地转一圈 |右转180度 |向右转30度 |向左转45度 |左转90度 |逆时针转60度 |顺时针转90度 | 分类总时间 | 分类匹配率 |
|------|------|------|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 28.06 | 13.63 | 10.19 | 16.95 | 10.70 | 14.47 | 9.78 | 103.78 | 100.00% |
| qwen3.5:0.8b | 2.06 | 3.59 | 78.32 | 1.60 | 2.44 | 1.93 | 846.07 | 936.01 | 57.14% |
| qwen3.5:2b | 3.42 | 3.30 | 3.87 | 3.76 | 4.61 | 3.20 | 3.16 | 25.32 | 100.00% |
| qwen3.5:4b | 30.09 | 14.64 | 7.16 | 32.80 | 11.41 | 12.27 | 10.72 | 119.09 | 100.00% |
### 组合指令 - 简单序列

| 模型 | 起飞，向前2m，然后... |起飞，向右2m，然后... |起飞，向后2m，然后... |起飞，向左1m，然后... | 分类总时间 | 分类匹配率 |
|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 36.03 | 13.24 | 51.09 | 18.67 | 119.03 | 100.00% |
| qwen3.5:0.8b | 2.27 | 4.98 | 2.26 | 846.42 | 855.92 | 75.00% |
| qwen3.5:2b | 2.57 | 3.57 | 2.81 | 3.44 | 12.39 | 100.00% |
| qwen3.5:4b | 20.27 | 6.60 | 17.79 | 21.65 | 66.31 | 100.00% |
### 组合指令 - 多步骤

| 模型 | 起飞到2米，然后向前... |起飞，升高2m，向前... |起飞，向前3m，向右... | 分类总时间 | 分类匹配率 |
|------|------|------|------|----------|--------|
| qwen3.5:latest | 9.12 | 26.54 | 20.76 | 56.42 | 100.00% |
| qwen3.5:0.8b | 2.98 | 2.04 | 5.82 | 10.84 | 66.67% |
| qwen3.5:2b | 3.39 | 4.06 | 4.74 | 12.19 | 100.00% |
| qwen3.5:4b | 16.97 | 18.56 | 24.67 | 60.20 | 100.00% |
### 组合指令 - 含航向控制

| 模型 | 起飞，向前2m，向左... |起飞，机头朝东，向前... |起飞，转向正南，然后... |起飞，顺时针转180... | 分类总时间 | 分类匹配率 |
|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 18.95 | 14.11 | 36.63 | 18.53 | 88.22 | 100.00% |
| qwen3.5:0.8b | 2.95 | 1.87 | 1.81 | 2.49 | 9.12 | 50.00% |
| qwen3.5:2b | 4.53 | 2.89 | 3.55 | 4.03 | 15.00 | 100.00% |
| qwen3.5:4b | 15.41 | 15.93 | 9.52 | 17.98 | 58.83 | 100.00% |
### 复杂组合

| 模型 | 起飞到3米，机头朝北... |起飞，升高1m，原地... | 分类总时间 | 分类匹配率 |
|------|------|------|----------|--------|
| qwen3.5:latest | 41.37 | 34.12 | 75.49 | 100.00% |
| qwen3.5:0.8b | 845.85 | 3.17 | 849.01 | 50.00% |
| qwen3.5:2b | 9.79 | 3.38 | 13.17 | 100.00% |
| qwen3.5:4b | 16.57 | 27.19 | 43.75 | 100.00% |
### 边界情况

| 模型 | 向前0.5m |向右转0度 |起飞到0.5米 | 分类总时间 | 分类匹配率 |
|------|------|------|------|----------|--------|
| qwen3.5:latest | 16.85 | 16.44 | 11.32 | 44.61 | 100.00% |
| qwen3.5:0.8b | 1.95 | 2.27 | 1.59 | 5.81 | 33.33% |
| qwen3.5:2b | 2.66 | 5.06 | 2.86 | 10.57 | 100.00% |
| qwen3.5:4b | 11.71 | 26.03 | 17.47 | 55.21 | 100.00% |

### 汇总

| 模型 | 基础动作 - 起飞降落 |基础动作 - 方向移动 |航向控制 - 绝对角度 |航向控制 - 相对角度 |组合指令 - 简单序列 |组合指令 - 多步骤 |组合指令 - 含航向控制 |复杂组合 |边界情况 | 总时间 | 总匹配率 |
|------|------|------|------|------|------|------|------|------|------|----------|--------|
| qwen3.5:latest | 32.29 | 75.74 | 165.00 | 103.78 | 119.03 | 56.42 | 88.22 | 75.49 | 44.61 | 760.58 | 100.00% |
| qwen3.5:0.8b | 914.76 | 16.40 | 1731.12 | 936.01 | 855.92 | 10.84 | 9.12 | 849.01 | 5.81 | 5328.99 | 67.44% |
| qwen3.5:2b | 16.73 | 22.73 | 26.26 | 25.32 | 12.39 | 12.19 | 15.00 | 13.17 | 10.57 | 154.37 | 100.00% |
| qwen3.5:4b | 56.97 | 109.23 | 148.09 | 119.09 | 66.31 | 60.20 | 58.83 | 43.75 | 55.21 | 717.68 | 100.00% |

## 性能总结

- qwen3.5:latest: 总时间 = 760.58秒, 匹配率 = 100.00% (43/43)
- qwen3.5:0.8b: 总时间 = 5328.99秒, 匹配率 = 67.44% (29/43)
- qwen3.5:2b: 总时间 = 154.37秒, 匹配率 = 100.00% (43/43)
- qwen3.5:4b: 总时间 = 717.68秒, 匹配率 = 100.00% (43/43)
