...
def run_top_p_test():
    ...
    # 添加编号逻辑，确保文件名唯一
    base_filename = f'top_p_test_report_{gpu_info.replace(" ", "_")}{report_suffix}'
    extension = '.md'
    counter = 1
    ...
    # 测试配置：只改变top_p，其他参数不变
    # 使用之前测试中最好的参数：qwen3.5:4b + 上下文 2048 + 温度 0.3
    test_configs = [
        {
            "name": "top_p 0.1",
            "top_p": 0.1
